...
This directory contains behavioral feature documentation for the Manager Applications service.
...
- [Module Bootstrap](features/module-bootstrap.md) - `POST /modules/{id}/bootstrap` returning ingress (scope-independent) or application-scoped egress bootstrap, with per-replica event-invalidated caching
